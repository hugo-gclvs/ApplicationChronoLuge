...
#include <memory>
#include "../../ChronoLuge/boundary/data/QZXing/QZXingFilter.h"
...
void QZXingFilter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QZXingFilter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QZXingFilter::staticMetaObject = { {
    ...
    qt_meta_stringdata_QZXingFilter.data,
    qt_meta_data_QZXingFilter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject QZXingFilterRunnable::staticMetaObject = { {
    ...
    qt_meta_stringdata_QZXingFilterRunnable.data,
    qt_meta_data_QZXingFilterRunnable,
    qt_static_metacall,
    nullptr,
    nullptr
} };
