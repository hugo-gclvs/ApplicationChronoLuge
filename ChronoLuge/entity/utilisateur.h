...
public:
    ...
    // Constructeur - Destructeur
        explicit Utilisateur(QString pseudo, QString mdp, QString mail = "0", QString nom = "0", QString prenom = "0", int age = 0, QString lienPdp = "0", int idUtilisateur = 0);
